    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            var adminClaim = new IdentityUserClaim<Guid>()
            {
                ...
                ClaimValue = admin.DisplayName
            };
            var userClaim = new IdentityUserClaim<Guid>()
            {
                Id = 1,
                UserId = user.Id,
                ClaimType = "DisplayName",
                ClaimValue = user.DisplayName
            };
            modelBuilder.Entity<IdentityUserClaim<Guid>>().HasData(adminClaim, userClaim);
